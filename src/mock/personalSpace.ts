...
export const MOCK_APPS: AppCard[] = [
  {
    ...
    status: 'published', modelInfo: '月之暗面 · Moonshot (128K)',
    description:
  ...
  },
  {
    ...
    status: 'draft', modelInfo: 'OpenAI · gpt-3-turbo-16k',
  ...
  },
  {
    ...
    status: 'draft', modelInfo: 'OpenAI · gpt-4o',
    description:
